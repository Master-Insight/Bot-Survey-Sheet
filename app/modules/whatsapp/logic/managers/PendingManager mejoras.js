...
class PendingManager {
  ...
  // * Carga los mensajes pendientes desde Google Sheets (optimizado)
  async loadPendingSurveys(to, messageId = null) {
    ...
    try {
      ...
      this.pendingSurveys = values
        ...
        .filter(([, , estado]) => !estado || estado.toString().trim() === "")
  ...
  // * Método privado para enviar una sola encuesta (mejorado)
  ...
  // * Envía la siguiente encuesta pendiente (con timeout)
